...
def load_usgs_observations(folder_path):
    ...
    observations_df['DateTime'] = pd.to_datetime(observations_df['DateTime'])
...
#     # Round observation timestamps to the nearest hour to match prediction timestamps
#     observations_hourly = observations_df.copy()
#     observations_hourly['timestamp'] = observations_hourly['DateTime'].dt.round('h')
    
#     # Drop the original DateTime column
#     observations_hourly.drop(columns=['DateTime'], inplace=True)
#     # Rename columns for clarity
#     observations_hourly.rename(columns={'Value': 'USGSFlowValue'}, inplace=True)
